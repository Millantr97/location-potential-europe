...
<div class="map-tools"><button id="draw-area" class="draw-area" type="button" aria-pressed="false">Draw an area</button><button id="clear-area" class="text-toggle" type="button" hidden>Clear area</button><span>Drag a box around the part of Europe you want to compare.</span></div>
