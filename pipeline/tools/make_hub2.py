...
html = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Location Potential Europe - site selection across {len(CITIES)} cities</title><meta name="description" content="Compare {total_seg:,} street and area segments across {len(CITIES)} European cities. Choose your scope - all Europe, a macro-region, countries or single cities - pick a concept, and see the best zones. Observed competition, area context and modelled estimates are clearly labelled."><link rel="canonical" href="https://millantr97.github.io/location-potential-europe/"><meta property="og:title" content="Location Potential Europe - where should your business open?"><meta property="og:description" content="Pick your scope, pick your concept, see the best zones across {len(CITIES)} European cities."><meta property="og:url" content="https://millantr97.github.io/location-potential-europe/"><meta property="og:type" content="website"><meta property="og:image" content="https://millantr97.github.io/location-potential-europe/assets/og.png"><link rel="manifest" href="manifest.webmanifest"><link rel="icon" href="assets/favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="styles.css?v=34"></head><body><header class="top"><div class="top-row"><div class="brand">Location <span>Potential</span><i class="brand-city">Europe</i></div><nav class="citynav" id="citynav" aria-label="Choose a city"></nav></div></header><main class="hub-wrap"><section class="hero on"><div><div class="eyebrow">Street-level site selection · {len(CITIES)} cities across Europe</div><h1>Where should your business open?</h1><p>Choose where you could open, pick your concept, and compare <b>{total_seg:,} street and area segments</b>. Every figure is labelled observed, area context or modelled.</p><aside class="truth"><strong>Read the labels, not just the score</strong><p><b class="c-obs">OBSERVED</b> recorded at the street. <b class="c-ctx">AREA CONTEXT</b> nearby residents and demographics. <b class="c-mod">MODELLED</b> transparent estimates. Verify any shortlist locally before signing.</p></aside></div></section>
<section id="compare-app"><h2>Find the best zone in your scope</h2>
<div class="step-h" id="step-scope"><span class="step-n">1</span> Where could you open? <span class="step-hint">combine regions, countries and single cities freely</span></div>
<div id="scope-chips" class="chip-row" role="group" aria-label="Macro-regions and countries"></div>
<div class="scope-city-pick"><label><span class="sr-only">Add individual cities</span><input id="scope-city-search" type="search" placeholder="...or add single cities, e.g. Madrid, Vienna, Paris" autocomplete="off"></label><div id="scope-cities-results" class="city-hits"></div><div id="scope-cities-picked" class="chip-row"></div></div>
<div id="scope-map" class="scope-map"></div>
<div class="step-h"><span class="step-n">2</span> What are you opening?</div>
<label><span class="sr-only">Search concepts</span><input id="concept-search" type="search" placeholder="Search a concept - e.g. coffee, gym, tapas..." autocomplete="off"></label>
<div id="concept-chips" class="chip-row" role="group" aria-label="Concepts"></div>
<div class="step-h"><span class="step-n">3</span> Best zones in your scope</div>
<div id="compare-results" aria-live="polite"></div>
</section>
<section id="cities"><h2>Or browse one city at a time</h2>{''.join(directory)}</section>
<section id="method"><h2>How the numbers are built</h2><p>Venues, units and station locations come from OpenStreetMap (ODbL). Residents and demographics come from the Eurostat Census 2021 1 km grid (UK cities: Census 2021 LSOA). Comparable street-level crime is not shown. Station flow and rents are modelled and labelled. Cross-city rankings convert modelled local-currency revenue to EUR at ECB reference rates for comparability only. This is a shortlisting tool, not a valuation.</p></section></main><footer class="hub-wrap"><div>Location Potential · Europe · verify shortlists with on-street counts, agent enquiries and licensing checks.</div><a href="privacy.html">Privacy Notice</a></footer><script src="cities.js?v=9"></script><script src="assets/compare-index.js"></script><script src="compare.js?v=2"></script><script src="pwa.js?v=1"></script></body></html>'''
